...
```Figueroa, N. and Billard, A. "Introduction to Bayesian Non-Parametrics for Gaussian Mixture Models and Hidden Markov Models" EPFL TECH-REPORT #XYZ.```
